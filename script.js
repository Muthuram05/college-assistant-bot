class FormValidation{
    ...
    validatename(){
        if(this.formValues.name === ""){
            ...
            this.showErrorMsg(1,this.errorValues.nameErr)
        } else if(this.formValues.name.length <= 4 ){
            this.errorValues.nameErr = "* Username must be atleast 5 Characters"
            this.showErrorMsg(1,this.errorValues.nameErr)
        } else if(this.formValues.name.length > 14){
            this.errorValues.nameErr = "* Username should not exceeds 14 Characters"
            this.showErrorMsg(1,this.errorValues.nameErr)
        } else {
    ...
    alertMessage(){
        const {usernameErr ,nameErr, emailErr , phonenumberErr , passwordErr , confirmpasswordErr}= this.errorValues
        if(usernameErr === "" && nameErr === "" && emailErr === "" && phonenumberErr === "" && passwordErr === "" && confirmpasswordErr === ""){
